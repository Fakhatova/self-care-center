...
// Create a variable for affirmation and mantra buttons, and recieve message.

// 1.radio buttons

var radios = document.getElementsByName('radio-message');

// 2.message button

var recieveMessage = document.querySelector('.message');

// display message for each radio button
...
function deleteAffirmation() {
  for (var i = 0; i < affirmations.length; i++) {
    if (affirmations[i] === affirmationsText) {
      affirmations.splice(i, 1)
      alert("Your affirmation has been deleted");
    }
  }
  displaySVG()
}
...
function deleteMantra() {
  for (var i = 0; i < mantras.length; i++) {
    if (mantras[i] === mantraText) {
      mantras.splice(i, 1)
      alert("Your mantra has been deleted");
    }
  }
  displaySVG()
}
